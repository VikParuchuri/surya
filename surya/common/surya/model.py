...
from surya.common.surya.decoder.model import SuryaDecoderModel
from surya.common.surya.embedder.model import SimpleTokenEmbedder
from surya.common.surya.encoder.model import SuryaEncoderModel
...
class SuryaModel(PreTrainedModel):
    ...
    def __init__(
        ...
        self.vision_projector = nn.Sequential(
            nn.Linear(self.vision_encoder.hidden_size, self.decoder.hidden_size),
            nn.GELU(),
            nn.Linear(self.decoder.hidden_size, self.decoder.hidden_size),
        )
