...
class Settings(BaseSettings):
    ...
    # Text recognition
    RECOGNITION_MODEL_CHECKPOINT: str = "vikp/text_recognizer_5"
    ...
    RECOGNITION_TURBO_MODE: bool = False # Predict N tokens ahead, don't use unless you understand surya internals
