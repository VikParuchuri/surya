...
class RecognitionPredictor(BasePredictor):
    ...
    def process_outputs(self, outputs: SuryaModelOutput, skip_box_idxs: torch.Tensor) -> ContinuousBatchOutput:
        ...
        is_special_token = (preds < self.processor.ocr_tokenizer.qwen_offset)  | (torch.isin(preds, self.device_bbox_ignore))
