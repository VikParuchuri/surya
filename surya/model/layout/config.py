...
LABEL_TO_ID["Figure"] = 7
LABEL_TO_ID["pageNumber"] = 5
...
class SuryaLayoutDecoderConfig(PretrainedConfig):
    ...
    def __init__(
        self,
        num_hidden_layers=3,
        vocab_size=MAX_SIZE["height"] + SPECIAL_TOKENS + 1, # Plus one because if max_size is 1024, you actually need 1025 tokens
        bbox_size=MAX_SIZE["height"] + SPECIAL_TOKENS + 1, # Special tokens for padding, bos, eos, (bos, eos are the same)
