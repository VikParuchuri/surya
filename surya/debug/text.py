...
def draw_text_with_playwright(bboxes, texts: List[str], image_size: Tuple[int, int]):
...
def draw_text_on_image(bboxes, texts, image_size: Tuple[int, int], font_path=None, max_font_size=60, res_upscale=2):
    if has_playwright:
